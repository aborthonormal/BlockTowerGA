...
CFLAGS=-Wall -I$(POLYDIR)Core/Dependencies/include -I$(POLYDIR)Core/Dependencies/include/AL -I$(POLYDIR)Core/Dependencies/include/freetype2 -I$(POLYDIR)Core/include/ -I$(POLYDIR)Modules/include -I$(POLYDIR)Modules/Dependencies/include -I$(POLYDIR)Modules/Dependencies/include/bullet
